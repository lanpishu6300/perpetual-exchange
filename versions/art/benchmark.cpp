...
std::string generateReport(const std::string& version_name, size_t num_orders, 
    ...
    report << "- **Implementation**: Adaptive Radix Tree\n";
    report << "- **Performance Target**: ~410K orders/sec, ~2.3μs\n";
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "========================================\n";
    std::cout << "Art Version Performance Benchmark\n";
    std::cout << "========================================\n";
    ...
    std::string report = generateReport("Art", num_orders - warmup,
