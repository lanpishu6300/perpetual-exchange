...
// #include "core/position.h"  // Not used in benchmark
...
void generate_report(const std::vector<std::pair<std::string, BenchmarkStats>>& results) {
    ...
    report << "High-Performance Matching Engine - Benchmark Report\n";
    report << "=====================================\n\n";
...
int main(int argc, char* argv[]) {
    std::cout << "High-Performance Matching Engine - Performance Benchmark\n";
    std::cout << "==========================================\n\n";
